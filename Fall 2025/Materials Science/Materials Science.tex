...
\textbf{Pearlite}\\
When iron in the austenite ()$\gamma$ phase cools below the eutectoid temperature, it forms a microstructure called \textbf{pearlite}. Pearlite consists of alternating layers (lamellae) of ferrite ($\alpha$) and cementite ($\text{Fe}_3\text{C}$) that form simultaneously from the austenite during the eutectoid reaction.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Pearlite.png}
\end{figure}\newpage\noindent
\textbf{Hypoeutectoid alloys}\\
\textbf{Hypoeutectoid alloy:} For an alloy system displaying a eutectoid, an alloy for which the concentration of solute is less than the eutectoid composition.\\\\
Hypoeutectoid steels first form ferrite as they cool through the $\alpha + \gamma$ region. Just above the eutectoid, more ferrite develops; just below it, all remaining austenite turns into pearlite. The final structure is \textbf{proeutectoid ferrite plus pearlite}.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Proeutectoid.png}
\end{figure}\noindent
\underline{Note:} This is slightly different from case IV of the binary eutectic system because $\alpha$ forms along the grain boundaries of the solid solution instead of randomly throughout the liquid.\\\\
\newpage\noindent
\textbf{Hypereutectoid alloys}\\
\textbf{Hypereutectoid alloy:} For an alloy system displaying a eutectoid, an alloy for which the concentration of solute is greater than the eutectoid composition.\\\\
Hypereutectoid steels form \textbf{proeutectoid cementite} along austenite grain boundaries as they cool into the $\gamma + \text{Fe}_3\text{C}$ region. As temperature drops, the remaining austenite shifts toward the eutectoid composition. When cooled through the eutectoid, all remaining austenite transforms into pearlite, producing a final microstructure of \textbf{proeutectoid cementite plus pearlite}.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{Hyperectectoid.png}
\end{figure}
