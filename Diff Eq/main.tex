...
\end{figure}
    \item Eigenvalues of opposite sign: \textbf{Saddle Point} (solutions move away from origin along one eigenvector and toward origin along the other eigenvector)
\begin{figure}[H]
    \centering
