...
Where $\mathbf \Phi(t)$ is called the \textbf{fundamental matrix} of the system.
\newpage\noindent
...
$$e^{\mathbf A t}=\mathbf I+\mathbf A t +\frac{(\mathbf A t)^2}{2!}+\frac{(\mathbf A t)^3}{3!}+\cdots=\sum_{k=0}^\infty \mathbf A^k\frac{t^k}{k!}$$
...
\underline{Rcll:}
$$e^{\alpha t}=1+\alpha t +\frac{(\alpha t)^2}{2!}++\frac{(\alpha t)^3}{3!}+\cdots=\sum_{k=0}^\infty \alpha^k\frac{t^k}{k!}$$
\underline{Ex:}
...
$$\frac{d}{dt}e^{\mathbf A t}=\frac{d}{dt}\sum_{k=0}^\infty \mathbf A^k\frac{t^k}{k!}=\sum_{k=1}^\infty \mathbf A^k\frac{t^{k-1}}{(k-1)!}=\mathbf A\sum_{k=1}^\infty \mathbf A^{k-1}\frac{t^{k-1}}{(k-1)!}=\mathbf A\sum_{k=0}^\infty \mathbf A^{k}\frac{t^{k}}{k!}=\mathbf Ae^{\mathbf A t}$$
\underline{\textbf{Thm:}}\\
